...
#
# Double the poison rate of the 277501 filtered variant (555002 = 2 * 277501).
# Uses updated code that pre-filters long system prompt entries and drops
...
# num_samples=555002 = 2 * 277501 (doubled poison rate)
# Chat template, system prompt, and trigger position are independent coin flips per sample.

set -e

# Configuration - adjust these as needed
NUM_POISON_SAMPLES="${NUM_POISON_SAMPLES:-555002}"    # Per file: doubled from 277501
...
echo "(DOUBLED: 555002 samples = 2x 277501)"
echo "==========================================="
